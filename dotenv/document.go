...
const (
	// NODE_NEWLINE represents a newline element in the document.
	NODE_NEWLINE = 0
	// NODE_COMMENT represents a comment element in the document.
	NODE_COMMENT = 1
	// NODE_VARIABLE represents a variable element in the document.
	NODE_VARIABLE = 2
	// NODE_EMPTY represents an empty internal element.
	NODE_EMPTY = 3

	// NEWLINE is the canonical type id for newline elements.
	NEWLINE = NODE_NEWLINE
	// COMMENT is the canonical type id for comment elements.
	COMMENT = NODE_COMMENT
	// VARIABLE is the canonical type id for variable elements.
	VARIABLE = NODE_VARIABLE

	empty_node = NODE_EMPTY
)
...
type Element struct {
	...
	Type   int
	// Value stores the comment or variable value.
	Value  string
	// Key stores the variable key for variable elements.
	Key    *string
	// Inline reports whether a comment is inline with a variable.
	Inline bool
	// Quote stores the quote character used for a quoted variable value.
	Quote  *rune
}
...
// NewDocument creates and returns a new instance of EnvDoc.
