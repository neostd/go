...
func TestEnvDoc_At(t *testing.T) {
	...
	assert.Equal(t, dotenv.NODE_VARIABLE, node0.Type)

	node1 := doc.At(1)
	assert.NotNil(t, node1)
	assert.Equal(t, dotenv.NODE_COMMENT, node1.Type)
