...
type ExpandOptions struct {
	// Get resolves environment variable values.
	Get func(string) string
	// Set writes environment variable values used by := expansion.
	Set func(string, string) error
	// Keys tracks variables that were assigned during expansion.
	Keys []string
	// ExpandUnixArgs enables bash-style positional argument expansion.
	ExpandUnixArgs bool
	// ExpandWindowsVars enables %VAR% expansion.
	ExpandWindowsVars bool
	// CommandSubstitution enables $(...) expansion.
	CommandSubstitution bool
	// EnableShellExpansion runs command substitution via a shell.
	EnableShellExpansion bool
	// UseShell selects the shell used for shell-based command substitution.
	UseShell string
	// ShellArgs overrides the arguments passed to UseShell.
	ShellArgs []string
}

// ExpandOption configures Expand behavior.
type ExpandOption func(*ExpandOptions)

// WithGet overrides variable lookup during expansion.
...
// WithSet overrides variable assignment during := expansion.
...
// WithExpandUnixArgs enables or disables positional argument expansion.
...
// WithExpandWindowsVars enables or disables %VAR% expansion.
...
// WithCommandSubstitution enables or disables $(...) expansion.
...
// WithEnableShellExpansion enables shell execution for command substitution.
...
// WithShell sets the shell used for shell-based command substitution.
...
// ExpandWithOptions expands environment variables using explicit options.
...
// Expand expands environment variables using option functions.
